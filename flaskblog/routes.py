...
# Add this function to the routes.py file to send email verification link
...
# Update the register route to send verification email
...
# Update the login route to check if the user is verified or not
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password, form.password.data):
            if user.verified:  # Check if user is verified
                ...
                flash('Please verify your email to log in.', 'danger')  # Add this line
        else:
